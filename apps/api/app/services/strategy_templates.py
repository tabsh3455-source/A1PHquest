...
_TEMPLATES: dict[str, StrategyTemplateSpec] = {
    ...
    "futures_grid": StrategyTemplateSpec(
        ...
        market_scope="perp",
        risk_level="high",
        runtime_strategy_type="futures_grid",
        ...
        fields=[
            *_COMMON_FIELDS,
            ...
            _field(
                ...
                step=1,
                default=3,
                description="Validated and traced at runtime for explainability. Exchange-side leverage API calls are not enforced in this phase.",
            ),
            _field(
                "direction",
                "Direction Bias",
                ...
                description="neutral keeps both sides, long only seeds buy ladders, short only seeds sell ladders.",
            ),
        ],
        tags=["Pionex", "Perp"],
    ),
